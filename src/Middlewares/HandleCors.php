...
namespace Tuezy\Middlewares;

use Closure;
use Fruitcake\Cors\CorsServiceProvider as CorsService;
...
class HandleCors
{
     ...
     *
     * @var \Fruitcake\Cors\CorsServiceProvider
     */
    protected $cors;
     ...
     * @param  \Fruitcake\Cors\CorsServiceProvider  $cors
     * @return void
     */
